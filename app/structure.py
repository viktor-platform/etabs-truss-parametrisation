...
def generate_model(truss_depth,x_bay_width,y_bay_width,n_diagonals,columns_height,joist_n_diags):
        ...
        column2 = Columns(
            height=columns_height, xo=x_bay_width, yo=0, zo=0, nodes_id=1, lines_id=1, component_name="Column"
        )
        column3 = Columns(
            height=columns_height, xo=0, yo=y_bay_width, zo=0, nodes_id=1, lines_id=1, component_name="Column"
        )
        column4 = Columns(
