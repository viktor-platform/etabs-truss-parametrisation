...
truss1 = Truss(
    height=truss_depth, width=x_bay_width, n_diagonals=n_diagonals, xo=0, yo=0, zo=columns_height, plane="xz"
)
truss2 = Truss(
    height=truss_depth, width=y_bay_width, n_diagonals=n_diagonals, xo=0, yo=0, zo=columns_height, plane="yz"
)
truss3 = Truss(
    height=truss_depth, width=y_bay_width, n_diagonals=n_diagonals, xo=x_bay_width, yo=0, zo=columns_height, plane="yz"
)
truss4 = Truss(
    height=truss_depth, width=x_bay_width, n_diagonals=n_diagonals, xo=0, yo=y_bay_width, zo=columns_height, plane="xz"
)
